...
class Controller_siswa{
    ...
    function POSTData ($nisn,$nis,$nama,$id_kelas,$alamat,$id_telp,$id_spp){

        // perintah POST data
        $this->MSiswa->POST($nisn,$nis,$nama,$id_kelas,$alamat,$id_telp,$id_spp);
    ...
    // Method untuk memasukan data ke dalam table
    function PUTData ($nisn,$nis,$nama,$id_kelas,$alamat,$id_telp,$id_spp){

        // perintah PUT data
        $this->MSiswa->PUT($nisn,$nis,$nama,$id_kelas,$alamat,$id_telp,$id_spp);
